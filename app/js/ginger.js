//Apache 2 license https://github.com/StickmanVentures/ginger
...
module.exports.Ginger = function() {
  ...
  var mousetracking = true; //on by default
...
*/
  ...
  return {
    selectMorph: function(name) { 
      select(name);
    },
    doMorph: function(position) { 
      updateMorph(position);
      morph();
    },
    init: function() {
      ...
      //TODO: this seems to make it too big
      //renderer.setSize(window.innerWidth, window.innerHeight);
      ...
      var elRenderer = document.getElementById( 'app'); 
